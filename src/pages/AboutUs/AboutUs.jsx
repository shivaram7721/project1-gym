    ...
    <div id="aboutus" className={styles.container}>
      ...
      <div className={styles.aboutus}>
        <div className={styles.right}>
          ...
          <br />
          <p className={styles.p}>
            We believe that fitness is not just about working out, it`&apos;`s
            about living a healthy and balanced lifestyle. That`&apos;`s why we
            offer a range of amenities to help you relax and rejuvenate after
            your workout. Our locker rooms and showers are spacious and
            well-equipped, and our saunas are the perfect place to unwind and
            destress. We also have a juice bar where you can refuel with
            delicious and healthy drinks and snacks. Our club is more than just
            a gym; it`&apos;`s a community of like-minded individuals who are
            passionate about living a healthy and active lifestyle. We provide a
            welcoming and inclusive environment where everyone is encouraged to
            unleash their potential and achieve their fitness goals.
          </p>
        </div>

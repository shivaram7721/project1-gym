  ...
  return (
    <div id="training">
        <div className={styles.meetTeam}>
            ...
            <p className={styles.contentMeet}>We are a team of experienced people, nutrition, sports 
                and fitness passionate experts with talent <br />and knowledge
                unsurpassed in the industry. Get to know us
            </p>
        </div>
      <div>
        {showTeam ? (

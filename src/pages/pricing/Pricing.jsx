  ...
  return (
    <div className={Style.container}>
      ...
      <div className={Style.card2}>
        ...
        <button className={Style.btns} onClick={() => navigate("/login")}>
          {" "}
          GET STARTED{" "}
        </button>
      </div>
      ...
      <div className={Style.content}>
        ...
        <p className={Style.p2}>
          At Gym base we offer wide range of membership with opposite to suit
          every budget. Everything from one Day Pass. Punch Pass to monthly or
          annual prepaid membership. What's more. We won't tie you in to a long
          term contract giving you greater flexibility. <br />
        </p>
